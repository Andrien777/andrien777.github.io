...
/** @type {string} */
const CACHE_VERSION = '1754168223|1558812980';
/** @type {string} */
const CACHE_PREFIX = 'TVBuilder-sw-cache-';
...
/** @type {string[]} */
const CACHEABLE_FILES = ["index.wasm","index.pck","index.side.wasm","libgdexample.web.template_release.wasm32.wasm"];
